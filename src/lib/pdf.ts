...
export async function generateSalarySlipPDF(
  ...
  const employeeMetaRows = [
    ...
    [
      ...
      { content: "Fixed Salary", styles: { fontStyle: "bold", textColor: cleanPrimaryRgb, fillColor: [240, 249, 255] } },
      { content: `: Rs. ${fixedGross.toLocaleString("en-IN")}/mo`, styles: { fontStyle: "bold", textColor: cleanPrimaryRgb } },
    ],
    [
      { content: "Bank A/C", styles: { fontStyle: "bold", textColor: [71, 85, 105], fillColor: [248, 250, 252] } },
      { content: `: ${employee.bankAcc || "—"}`, styles: { textColor: [15, 23, 42] } },
      { content: "Bank IFSC", styles: { fontStyle: "bold", textColor: [71, 85, 105], fillColor: [248, 250, 252] } },
      { content: `: ${employee.bankIfsc || "—"}`, styles: { textColor: [15, 23, 42] } },
